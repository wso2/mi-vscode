...
export class Overview {
    ...
    public async init(projectName : string = "testProject", isMultiWorkspace : boolean = false) {
        ...
        if (iframeTitle != overviewTitle && !onManageDependencies) {
    ...
    public async openManageDependencies() {
        ...
        // "Connector Dependencies" is the default active tab in the Manage Dependencies view, so wait for it to be visible to ensure the view has loaded.
