...
export function registerMiVisualizerRpcHandlers(messenger: Messenger, projectUri: string): void {
    ...
    messenger.onRequest(getWorkspaceMiProjects, () => rpcManger.getWorkspaceMiProjects());
    ...
    messenger.onRequest(getConsolidatedRemoteDeployConfigs, () => rpcManger.getConsolidatedRemoteDeployConfigs());
    messenger.onRequest(executeConsolidatedRemoteDeployWithParams, (args: ExecuteRemoteDeployParams) => rpcManger.executeConsolidatedRemoteDeployWithParams(args));
}
