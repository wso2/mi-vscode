...
export function registerMiDiagramRpcHandlers(messenger: Messenger, projectUri: string): void {
    ...
    messenger.onRequest(parsePomGav, (args: ParsePomGavRequest) => rpcManger.parsePomGav(args));
    ...
    messenger.onRequest(updateMcpInboundEndpoint, (args: UpdateMcpInboundEndpointRequest) => rpcManger.updateMcpInboundEndpoint(args));
