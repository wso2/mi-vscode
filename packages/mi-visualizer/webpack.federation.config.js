...
// Separate build that exposes the MI project-creation form as a Module
...
module.exports = {
    entry: "./src/views/Embedded/federation-bootstrap.ts",
    target: "web",
    ...
    plugins: [
        new ModuleFederationPlugin({
            ...
            exposes: {
                "./EmbeddedMiProjectForm": "./src/views/Embedded/EmbeddedMiProjectForm.tsx",
            },
            // Only the React runtime is shared as a singleton so the host and
            // remote agree on one copy; everything else (ui-toolkit, mi-core,
            // yup, react-hook-form) is bundled to keep the remote portable
